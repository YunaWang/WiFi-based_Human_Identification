function svd(folder, output_folder, width, height, NUM_ANT_PAIR)
	...
	%SV_feat_folder = strcat('/home/umcic/Desktop/Yuna/wifi_vision-master/signal_process/feature/singular_value/', parts(end));
	...
	vmins = {[],[],[],[],[],[]}; vmaxs = {[],[],[],[],[],[]};
	new_H_min  = repmat(Inf, 1, 6); new_H_max  = repmat(-Inf, 1, 6);
